...
// font ideas:
// https://fonts.google.com/noto/specimen/Noto+Serif+Display?stroke=Serif
// https://fonts.google.com/specimen/Kurale?stroke=Serif
// https://fonts.google.com/specimen/Ibarra+Real+Nova?stroke=Serif
// isenheim
